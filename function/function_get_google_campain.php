...
function GetGoogleTextAds(AdWordsUser $user, $adGroupId) {
  ...
  // Create selector.
  $selector = new Selector();
  $selector->fields = array('Headline','Description1','Description2','Url','DisplayUrl', 'Id');
  ...
  do {
    ...
    if (isset($page->entries)) {
      foreach ($page->entries as $adGroupAd) {
        ...
        $get_tex_ads_id_headline[]= $adGroupAd->ad->id ."--".$adGroupAd->ad->headline."--".$adGroupAd->ad->description1."--".$adGroupAd->ad->description2."--".$adGroupAd->ad->displayUrl."--".$adGroupAd->ad->url;
        
        
      }
    } else {
      $msg = "No text ads were found.\n";
    }
